...
public class ClientControllerTests extends TddApplicationTests {
    ...
    @Test
    public String testFindById() throws Exception {
    ...
    public void testUpdate() throws Exception
    {
        this.mockMvc.perform( MockMvcRequestBuilders
                        .put("/clients")
                        .content(asJsonString(new Client("65eb1a3669568b43470ef7df", "Mariana Consolaro", "mariana.consolaro@gmail.com", "9994545429", "440120165656")))
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
